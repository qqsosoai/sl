...
<body>
					...
					<div class="form-horizontal">
						<fieldset>
							<div class="input-prepend" title="用户名" data-rel="tooltip">
								<span class="add-on"><i class="icon-user"></i></span><input autofocus class="input-large span10" id="username" type="text" />
							</div>
							<div class="clearfix" style="color: red"></div>

							<div class="input-prepend" title="用户密码" data-rel="tooltip">
								<span class="add-on"><i class="icon-lock"></i></span><input class="input-large span10" id="password" type="password" />
							</div>
							<div class="clearfix" style="color: red"></div>

							<div class="input-prepend">
							<label class="remember" for="my"><input type="checkbox" id="my" />记住我</label>
							</div>
							<div class="clearfix neterror" style="color: red"></div>
	...
	<script src="/static/SLjs/login.js"></script>
</body>
</html>
