$(document).ready(function(){
    ...
    for (var i=0;i<json.length;i++){
		...
		result += "<li><ul class='nav nav-tabs nav-stacked' id='test"+i+"'>"
		for (var j=0;j<json[i].childMenu.length;j++){
            var pic;
    		switch (j){
                case 0:
                    pic = "icon-home";break;
    		...
    		result += "<li><a class='ajax-link' href='"+json[i].childMenu[j].funcUrl+"'><i class='"+pic+"'>" +
				"</i><span class='hidden-tablet'>"+json[i].childMenu[j].functionName+"</span></a></li>"
		}
		result += "</ul></li>";
 	}
    $("#menus").append(result);
